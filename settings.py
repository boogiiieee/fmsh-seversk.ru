...
MIDDLEWARE_CLASSES = (
	...
	'profiles.middleware.UserAnonymousMiddleware',
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
	...
	'subject.context_processors.custom_proc',
	'project.context_processors.custom_proc',
)
...
ROBOKASSA_EXTRA_PARAMS = ['uid', 'lesson', 'task', 'back']

LOGIN_REDIRECT_URL = '/'
ACCOUNT_ACTIVATION_DAYS = 2

DEFAULT_FROM_EMAIL = 'fmsh-seversk@gmail.com'
...
TINYMCE_DEFAULT_CONFIG={
	'theme' : "advanced",
	'plugins' : ",mformulas,".join(TINYMCE_PLUGINS),
	#'language' : 'ru',
	...
	'theme_advanced_buttons2' : "mformulas,|,table,|,delete_row,delete_table,|,row_after,row_before,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,link,unlink,|,link,unlink,anchor,image,media,|,cleanup,|,code",
