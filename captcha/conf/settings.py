...
CAPTCHA_FONT_SIZE = getattr(settings,'CAPTCHA_FONT_SIZE', 20)
...
CAPTCHA_FOREGROUND_COLOR= getattr(settings,'CAPTCHA_FOREGROUND_COLOR', '#695d47')
...
CAPTCHA_LENGTH = int(getattr(settings, 'CAPTCHA_LENGTH', 6)) # Chars
